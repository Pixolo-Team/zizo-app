...
import { fadeIn, shrinkIn, slideInUp } from "@/lib/animations";
        ...
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-2 ">
            ...
            <Motion variants={shrinkIn} delay={0.2}>
              <Button
                className="h-11 w-full rounded-full border-none shadow-none hover:opacity-90 transition-opacity items-center justify-center pointer-events-auto cursor-pointer"
                style={{
                  background:
            ...
            {/* Instagram Button */}
            <Motion variants={shrinkIn} delay={0.4}>
              <Button
                className="h-11 w-full rounded-full border-none shadow-none hover:opacity-90 transition-opacity items-center justify-center pointer-events-auto cursor-pointer"
                style={{
                  background:
          ...
          <Motion variants={slideInUp} delay={0.5}>
            <div className="py-2 rounded-[99px] pl-4 pr-2 flex items-center justify-between border border-n-200">
              <p className="text-sm text-n-500 w-[80%] overflow-hidden text-ellipsis whitespace-nowrap">
                {copyLink}
              </p>
